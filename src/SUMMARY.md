...
- [Iniziamo](ch01-00-getting-started.md)
  
  - [Installazione](ch01-01-installation.md)
  - [Hello, World!](ch01-02-hello-world.md)
  - [Hello, Cargo!](ch01-03-hello-cargo.md)

- [Programmare un Guessing Game](ch02-00-guessing-game-tutorial.md)

- [Concetti Comuni della Programmazione](ch03-00-common-programming-concepts.md)
  
  - [Variabili e Mutabilità](ch03-01-variables-and-mutability.md)
  - [Tipi Dati](ch03-02-data-types.md)
  - [Funzioni](ch03-03-how-functions-work.md)
  - [Commenti](ch03-04-comments.md)
  - [Control Flow](ch03-05-control-flow.md)

- [Capire l'Ownership](ch04-00-understanding-ownership.md)
...
- [Usare Struct per Strutture di Dati Correlati](ch05-00-structs.md)
  
  - [Definire ed Istanziare le Struct](ch05-01-defining-structs.md)
  - [Un Programma-Esempi che Usa le Struct](ch05-02-example-structs.md)
  - [Sintassi dei Metodi](ch05-03-method-syntax.md)

- [Enum e Pattern Matching](ch06-00-enums.md)
  
  - [Definire un Enum](ch06-01-defining-an-enum.md)
  - [Il costrutto di Control Flow `match`](ch06-02-match.md)
  - [Control Flow conciso con `if let`](ch06-03-if-let.md)
